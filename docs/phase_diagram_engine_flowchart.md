...
| `GENERATE STARTING POINTS` | §3, Fe-Mo γ-loop note | user-supplied or predefined extra start points | **missing** — single start point only today |
...
POINTS` (for disconnected diagram components) is a second, smaller gap
