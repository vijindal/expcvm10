...
/** Wraps {@link CalculationSession#calculateInitialState}. */
public final class InitialStateCalculationType
        implements CalculatingType<InitialStateCalculationType.Params, EquilibriumResult> {
    ...
    public CalculationKind kind() {
        return CalculationKind.INITIAL_STATE;
    }
    ...
    public EquilibriumResult run(CalculationSession session, ModelSelection model, Params p)
        ...
        return session.currentInitialState();
    }
}
