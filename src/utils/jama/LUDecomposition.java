 ...
 * LU Decomposition.
 * <P>
 * For an m-by-n matrix A with m greater than= n, the LU decomposition is an m-by-n unit
 * lower triangular matrix L, an n-by-n upper triangular matrix U, and a
 * permutation vector piv of length m so that A(piv,:) = L*U. If m less than n, then L
 * is m-by-m and U is m-by-n. <P> The LU decompostion with pivoting always
