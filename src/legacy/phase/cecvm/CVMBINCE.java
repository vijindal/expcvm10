package legacy.phase.cecvm;

import util.Mat;
import util.CholeskyDecomposition;
import util.Matrix;
import util.Utils;
import util.DataReader;
import util.Print;
import util.LUDecomposition;
// import system.database.stdst;  // REMOVED: stdst.java deleted (moved G0 to model layer)
import util.AppLevel;
import util.Trace;
import java.io.*;
import java.util.StringTokenizer;
import java.util.logging.Logger;
import legacy.phase.PHASEBINCE;
...
//        }
    ...
    public void setT(double T_In) throws IOException {//vj-2012-03-16
        this.T = T_In;
        // updateStdst();  // DEPRECATED: stdst class removed, G0 moved to model layer
        isGMinimized = false;
    }
    ...
    // DEPRECATED: stdst class removed (G0 moved to model layer)
    /*
