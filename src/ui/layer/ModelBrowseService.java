...
/**
 * Shared bridge between {@link ApplicationLayer}'s browsing methods
 * ({@link ApplicationLayer#availableElements}/{@link
 * ApplicationLayer#availablePhasesFor}) and the three UIs (GUI, CLI,
 ...
 * user-facing element choice. {@link ApplicationLayer#availableElements}
...
public class ModelBrowseService {
    ...
    public ModelBrowseService(ApplicationLayer session) {
        this.session = session;
    }

    /**
     * Elements a user can actually pick from {@code tdbFilePath} --
     * {@link ApplicationLayer#availableElements} with the reserved
     * pseudo-elements ({@code /-}, {@code VA}) removed, sorted
     * alphabetically.
     *
     * <p>{@link ApplicationLayer#availableElements} returns elements in
     ...
     * ApplicationLayer#availablePhasesFor}, kept here so callers only
