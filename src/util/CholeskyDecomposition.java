 ...
 * public contracts. Neither The MathWorks nor NIST assumes any responsibility
...
public class CholeskyDecomposition 
   ...
   */
  public Matrix solve(Matrix B) throws ArithmeticException{
    if (B.getRowDimension() != n) {
      throw new IllegalArgumentException("Matrix row dimensions must agree.");
    }
    if (!isspd) {
      throw new ArithmeticException("CholeskyDecomposition:solve() Matrix is not symmetric positive definite.");
    }
