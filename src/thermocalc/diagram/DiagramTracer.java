...
public class DiagramTracer {
     ...
     */
    public PhaseDiagram calculate(List<PhaseModelPort> candidates,
                                   AxisConfig[] axes,
     ...
     */
    private void calculateStep(List<PhaseModelPort> candidates,
                                AxisConfig[] axes,
                                double[] startAxisValues,
                                double fixedT, double fixedP,
                                double[] compOverAll,
     ...
     */
    private void calculateMap(List<PhaseModelPort> candidates,
                               AxisConfig[] axes,
                               double[] startAxisValues,
                               double fixedT, double fixedP,
                               double[] compOverAll,
     ...
     */
    private DiagramNode findInitialNode(List<PhaseModelPort> candidates,
                                         AxisConfig[] axes,
                                         double[] startAxisValues,
                                         double fixedT, double fixedP,
                                         double[] compOverAll,
