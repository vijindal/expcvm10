...
import calbince.CalVars.CalcSet.CalcType.Calculation;
import database.tdb;
...
/**
 *
 * @author admin This class handles all the data required for a calculations
...
public class CalVars {
    ...
    private ArrayList<CalcSet> calcSetList; // to store lists of Calculation sets 
    ...
    /*
        this class is for handelling Calculation set data which is defined by a particular element list. 
        each Calculation set may consists of several types of calculations such enthalpy of mixing, 
    ...
    public class CalcSet {
        ...
        /*
            This class is for handelling Calculation-type data and defined by a combination of (i) method 
        ...
        public class CalcType {
            ...
            /*
                This class handles Calculation type data which is defined by external conditions such as 
                T, P, compositions.
                for example phase-equlibria bcc-liquid type data, several possible calculations are:
                    conditions P = 1 atm, T=1200K, x(Ti)=0.9
                    conditions P = 1 atm
                        x(Ti) = 0.1 to 0.9 in the steps of 0.1 
             */
            public class Calculation {
                ...
                public Calculation(double[] condT, double[] condP, double[][] condX) {
                    T = new ArrayList<>();
                    P = new ArrayList<>();
                    x = new ArrayList<>();
    ...
    public void printCalcSetList() {
        ...
        for (CalcSet calcSet : calcSetList) {
            ...
            for (CalcType calcType : calcSet.calcTypes) {
                ...
                for (Calculation calculation : calcType.calculations) {
