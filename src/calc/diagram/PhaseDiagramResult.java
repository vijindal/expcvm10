...
/**
 * Output DTO for a phase diagram calculation ({@link
 * PhaseDiagramEngine#calculatePhaseDiagram}). Lives in {@code
 * calc.diagram}, not {@code ui.result}: {@code calc/} must not import
 * {@code ui/} (see README's boundary rules), so this DTO is a {@code
 * calc/diagram} type {@code ui/} imports, not the reverse.
 *
